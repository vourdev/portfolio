...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento row-span-1 flex flex-col justify-between space-y-4 rounded-xl border border-white/10 bg-neutral-950 p-4 shadow-none transition duration-200 hover:shadow-xl hover:shadow-blue-500/10",
        className,
      )}
    >
      {header}
